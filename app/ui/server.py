    ...
    <script>
      ...
      function defaultParams(strategy) {
        ...
        if (strategy === 'intraday_vwap_momentum') {
          ...
          // Quality filters:
          // - min_impulse_atr_mult: require entry candle to be an impulse (reduces chop losses)
          // - min_vwap_dist_atr_mult: require close to be away from VWAP (reduces micro-noise)
          return {"timeframe":"1min","vwap_window":60,"ema_fast":10,"ema_slow":30,"require_fast_slope":false,"entry_mode":"cross_or_retest","retest_lookback":10,"retest_touch_atr_mult":"0.15","require_retest_breakout":true,"trend_timeframe":"1h","trend_ema_fast":20,"trend_ema_slow":50,"atr_period":14,"atr_regime_period":100,"atr_regime_min_ratio":"0.6","atr_regime_max_ratio":"1.8","adx_period":14,"adx_min":"18","bb_period":20,"bb_std_mult":"2.0","bb_width_lookback":20,"bb_width_mult":"1.05","atr_sl_mult":"1.5","atr_tp_mult":"3.0","atr_trail_mult":"1.0","max_hold_bars":30,"min_impulse_atr_mult":"0.8","min_vwap_dist_atr_mult":"0.15","risk_per_trade_pct":0.25,"volume_window":30,"min_volume_ratio":"1.15","cooldown_bars":5,"exit_before_session_end_minutes":10,"exit_confirm_bars":2,"exit_on_vwap_cross":true,"trade_sessions":[["10:00","18:00"]]};
        }
